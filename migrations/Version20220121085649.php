 ...
 */
final class Version20220121085649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rib (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, iban VARCHAR(255) NOT NULL, bic VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BFB7B5B6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rib ADD CONSTRAINT FK_BFB7B5B6A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rib DROP FOREIGN KEY FK_BFB7B5B6A76ED395');
